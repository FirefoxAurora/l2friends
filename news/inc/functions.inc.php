...
function echofooter(){
    ...
    $skin_footer = preg_replace("/{copyrights}/", "<div style='font-size: 9px'>Powered by <a style='font-size: 9px' href=\"http://megateam.info/\" target=_blank>$config_version_name</a> © 2007  <a style='font-size: 9px' href=\"http://megateam.info/\" target=_blank>Napas</a>.</div>", $skin_footer);
