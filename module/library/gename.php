...
function TavernNames(){
 ...
 <center><h3>Генератор имен</h3></center>
        <br>
...
<center>
  ...
  <tr> 
    <form>
      <td align="middle"> 
<input type="button" value=" Страна " name="button" onClick="CountryNames();" class="bbcodes">

      </td>
    </form>
    <form>
      <td align="middle"> 
<input type="button" value="   Карлик   " name="button" onClick="CountryNames();" class="bbcodes">

      </td>
    </form>
    <form>
      <td align="middle"> 
<input type="button" value="     Эльф    " name="button" onClick="CountryNames();" class="bbcodes">
      </td>
    </form>
  </tr>
  <tr> 
    <form>
      <td align="middle"> 
        <input type="button" value="Финское" name="button" onClick="CountryNames();" class="bbcodes">
      </td>
    </form>
    <form>
      <td align="middle"> 
        <input type="button" value="     Гном     " name="button" onClick="CountryNames();" class="bbcodes">
      </td>
    </form>
    <form>
      <td align="middle"> 
              <input type="button" value="Полурослик" name="button" onClick="CountryNames();" class="bbcodes">
      </td>
    </form>
  </tr>
  <tr> 
    <form>
      <td align="middle"> 
       <input type="button" value="    Орк   " name="button" onClick="CountryNames();" class="bbcodes">
      </td>
    </form>
    <form>
      <td align="middle"> 
  <input type="button" value="Саксонское" name="button" onClick="CountryNames();" class="bbcodes">
      </td>
    </form>
    <form>
      <td align="middle"> 
       <input type="button" value="    Кабак    " name="button" onClick="CountryNames();" class="bbcodes">
      </td>
    </form>
  </tr>
  <tr> 
    <form>
      <td align="middle"> 
<input type="button" value="  Город  " name="button" onClick="CountryNames();" class="bbcodes">
